                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="form-group checkbox-wrp">
                                <label>
                                    <input type="checkbox" @if($near_miss[0]->missed_tablet=='1') checked @endif  name="missed_tablet" class="minimal" value="missed_tablet"  />&nbsp;Missed tablet                                </label>
                                <label>
                                    <input type="checkbox" @if($near_miss[0]->extra_tablet=='1') checked @endif name="extra_tablet" class="minimal" value="extra_tablet"  />&nbsp;Extra tablet
                                </label>
                                <label>
                                    <input type="checkbox" @if($near_miss[0]->wrong_tablet=='1') checked @endif name="wrong_tablet" class="minimal" value="wrong_tablet"  />&nbsp;Wrong tablet
                                </label>
                                <label>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="person_involved"  value="{{$near_miss[0]->person_involved}}"  id="person_involved" class="form-control" >
                            </div>
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control"  style="resize: none;" rows="4" name="initials" id="initials"   placeholder="Initials.">{{$near_miss[0]->initials}}</textarea>
                              </div>

                              <div class="row">
                                <div class="col-md-2">
                                  <div class="form-group">
                                      <button type="submit" class="btn btn-primary">Update Near Miss</button>
                                  </div>
                                </div>
