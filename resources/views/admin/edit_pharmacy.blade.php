            ...
            @endif
              ...
              <div class="box box-primary">
                <div class="box-header pre-wrp">
                    <form action="{{ url('admin/update_pharmacy/'.$pharmacy->website_id) }}" method="post" autocomplete="off">  <!--dashboard-->
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                          <div class="col-xs-6">
                                ...
                                <label for="company_name">Company Name <span class="text-danger">*</span></label>
                                    <input type="text"  name="company_name" maxlength="50" value="{{$pharmacy->company_name}}" id="company_name" required="required" class="form-control" placeholder="Company Name"/>
                                </div>
                                <!-- <div class="form-group" id="host-name-div" style="">
                                    <label>We will setup packnpeaks for you at:</label><br>
                                    https://www.<input type="text" style="border:none;" value="{{$pharmacy->host_name}}" maxlength="50" name="host_name" maxlength="50" id="host_name"  autocomplete="host-name">.packnpeaks.tk
                            ...
                            <div class="col-xs-6">  
                              <div class="form-group">
                                    ...
                                    <!-- <div class="input-group"> -->
                                      ...
                                      <input type="text" required="required"  name="phone" value="{{$pharmacy->phone?$pharmacy->phone:'04'}}" class="form-control" maxlength="10" onkeypress="return restrictAlphabets(event);"  placeholder="Phone"/>
                                    </div>
                                </div>
                               <div class="form-group">
                                ...
                                <label for="email">Email <span class="text-danger">*</span> <span class="text-danger"></span></label>
                                    <input type="text"  value="{{$pharmacy->email}}"  name="email" readonly class="form-control" placeholder="Business Email"/>
                                </div>
                                <div class="checkbox icheck">
                                    <label> <input type="checkbox" name="term" required="required" checked  > <span class="text-danger">*</span>  I agree to the general terms and conditions . </label>
                                </div>
