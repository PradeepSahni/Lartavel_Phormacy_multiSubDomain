                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="patient_name" id="patient_name" class="form-control">
                                  ...
                                  @foreach($all_patients as $row)
                                   <option value="{{$row->id}}" @if($row->id==$pickup[0]->patient_id) selected @endif >{{$row->first_name.' '.$row->last_name}}</option>
                                  @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="dob">Date Of Birth <span class="text-danger"> *</span></label>
                                <input type="date" class="form-control" value="{{$pickup[0]->dob}}"  required name="dob" id="dob" placeholder="Date Of Birth" max="{{Carbon\Carbon::now()->format('Y-m-d')}}" >
                              </div>
                            <div class="form-group">
                              <label for="no_of_weeks">Number of Weeks <span class="text-danger"> *</span></label>
                              <input type="text" class="form-control" value="{{$pickup[0]->no_of_weeks}}" maxlength="2" onkeypress="return restrictAlphabets(event);" id="no_of_weeks"  required name="no_of_weeks" placeholder="No Of Weeks">
                            </div>

                              <label class="mt-20">Location <span class="text-danger"> *</span></label>
                              <div class="form-group checkbox-wrp">
                                <label>
                                    <input type="checkbox" @if(in_array("shelf",explode(',',$pickup[0]->location))) checked @endif name="location[]" class="minimal" value="shelf"  />&nbsp;Shelf                                
                                </label>
                                <label>
                                    <input type="checkbox" @if(in_array("fridge",explode(',',$pickup[0]->location))) checked @endif name="location[]" class="minimal" value="fridge"  />&nbsp;Fridge
                                </label>
                                <label>
                                    <input type="checkbox" @if(in_array("safe",explode(',',$pickup[0]->location))) checked @endif name="location[]" class="minimal" value="safe"  />&nbsp;Safe
                                </label>
                              </div>
                            ...
                            <label class="mt-20">Who is picking up? <span class="text-danger"> *</span></label>
                              <div class="form-group mt-10">
                                  <label>
                                    <input type="radio" @if($pickup[0]->pick_up_by=='carer') checked @endif  name="who_pickup" class="flat-red"  value="carer" /> Carer
                                  </label>
                                  <label>
                                    <input type="radio" @if($pickup[0]->pick_up_by=='delivery') checked @endif name="who_pickup"   class="flat-red" value="delivery"  /> Delivery
                                  </label>
                                  <label>
                                    <input type="radio" @if($pickup[0]->pick_up_by=='patient') checked @endif name="who_pickup"   class="flat-red" value="patient"  /> Patient
                                  </label>
                              </div>

                              <div class="form-group div_carer_name" >
                                @if($pickup[0]->pick_up_by=='carer')
                                <label for="carer_name">Carer`s Name <span class="text-danger"> *</span></label> <input type="text" value="{{$pickup[0]->carer_name}}" class="form-control" maxlength="20"  required id="carer_name" name="carer_name" placeholder="Carer Name..">
                                @endif
                              </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="row">
                              ...
                              <!-- textarea -->
                              <div class="form-group">
                                <label for="note">Notes From Patient <span class="text-danger"> *</span></label>
                                <textarea class="form-control" required style="resize: none;" rows="4" name="note" id="note"   placeholder="Note for Patient ...">{{$pickup[0]->notes_from_patient}}</textarea>
                              </div>
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        $("input[type=radio][name='who_pickup']").on('ifToggled', function(event){
            ...
            if($(this).val()=='carer')
            {   
              $('.div_carer_name').html('<label for="carer_name">Carer`s Name</label> <input type="text" class="form-control" maxlength="20"  required id="carer_name" name="carer_name" placeholder="Carer Name..">');
            }
            else
            {
              $('.div_carer_name').html("");
    ...
    $('#patient_name').click(function(){
           if($(this).val()){
              ...
              $.ajax({
                  ...
                  data: {website_id:$('#company_name').val(),patient_id:$('#company_name').val(),"_token":"{{ csrf_token() }}"},
                  beforeSend: function() {
