                  ...
                  <div class="box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" maxlength="2" onkeypress="return restrictAlphabets(event);" id="no_of_weeks" value="{{old('no_of_weeks')}}"   name="no_of_weeks" placeholder="No Of Weeks">
                            </div>
                              ...
                              <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <input type="checkbox" name="dd" {{old('dd')?'checked':''}}  class="minimal" value="1"  />&nbsp;DD                                </label>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-9">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control"  style="resize: none;" rows="6" name="note" id="note"   placeholder="Note for Patient ...">{{old('note')}}</textarea>
                              </div>
