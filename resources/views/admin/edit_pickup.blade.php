                       ...
                       <div class="col-md-offset-5 col-md-7">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" readonly="readonly" style="border: none; box-shadow: none; color:blue;"  id="last_pick_up_date" name="last_pick_up_date" value="{{$pickup[0]->last_pick_up_date}}"> 
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" readonly="readonly" style="border: none; box-shadow: none; color:blue;"  id="weeks_last_picked_up" name="weeks_last_picked_up" value="{{$pickup[0]->weeks_last_picked_up}}" > 
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" readonly class="form-control" value="{{$pickup[0]->dob}}"   name="dob" id="dob" placeholder="Date Of Birth" max="{{Carbon\Carbon::now()->format('Y-m-d')}}" >
                              </div>
                            <div class="form-group">
                              <label for="no_of_weeks">Number of Weeks <span class="text-danger"> *</span></label>
                              <input type="text" class="form-control" value="{{$pickup[0]->no_of_weeks}}" maxlength="2" onkeypress="return restrictAlphabets(event);" id="no_of_weeks"   name="no_of_weeks" placeholder="No Of Weeks">
                            </div>
                              ...
                              <div class="form-group checkbox-wrp">
                                ...
                                @if(isset($all_Location)  && count($all_Location))
                                  @foreach($all_Location as  $value)
                                    <label>
                                        <input type="checkbox" {{ (is_array(explode(',',$pickup[0]->location)) and in_array($value->id, explode(',',$pickup[0]->location))) ? ' checked' : '' }} name="location[]" class="minimal " value="{{$value->id}}"  />&nbsp;{{$value->name}} &nbsp;                               
                                    <label>
                                  @endforeach
                               @endif
                            ...
                            <label class="mt-20">Who is picking up? <span class="text-danger"> *</span></label>
                              ...
                              <div class="form-group div_carer_name" >
                                @if($pickup[0]->pick_up_by=='carer' ||  old('who_pickup')=='carer' )
                                  <label for="carer_name">Carer`s Name <span class="text-danger"> *</span></label> <input type="text" value="{{$pickup[0]->carer_name}}" class="form-control" maxlength="20"   id="carer_name" name="carer_name" placeholder="Carer Name..">
                                @endif
                              </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="row">
                              ...
                              <!-- textarea -->
                              <div class="form-group">
                                <label for="note">Note From Patient </label>
                                <span style="color:blue;" class="lastnotedate pull-right"> </span>
                                <textarea class="form-control"  style="resize: none;" rows="4" name="note" id="note"   placeholder="Note for Patient ...">{{$pickup[0]->notes_from_patient}}</textarea>
                              </div>
                        </div>
                        <div class="row">
