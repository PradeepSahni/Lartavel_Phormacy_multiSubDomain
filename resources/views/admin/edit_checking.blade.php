          ...
          <div class="row">
            ...
            @endif
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="{{url('admin/update_checking/'.$get_checking[0]->website_id.'/'.$get_checking[0]->id)}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                  <div class="box-body">
                              ...
                              <label for="patient_name">Patient Name <span class="text-danger"> *</span></label>
                                <select name="patient_name" id="patient_name" class="form-control">
                                  ...
                                  @foreach($all_patients as $row)
                                   <option value="{{$row->id}}" @if($row->id==$get_checking[0]->patient_id) selected @endif >{{$row->first_name.' '.$row->last_name}} ( {{$row->dob?date("j/n",strtotime($row->dob)):""}} ) </option>
                                  @endforeach
                                </select>
                            </div>
                               ...
                               <div class="col-md-5">
                                <div class="signature-component btn btn-group">
                                  ...
                                  <!-- <button type="button" id="showPointsToggle">Show points?</button> -->
                                   ...
                                   <img  src="{{$get_checking[0]->pharmacist_signature}}" style="border: 1px solid lightgray;width: 85%;"/>
                               </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" value="{{$get_checking[0]->no_of_weeks}}" maxlength="2" onkeypress="return restrictAlphabets(event);" id="no_of_weeks"   name="no_of_weeks" placeholder="No Of Weeks">
                            </div>
                              <div class="row">
                                <div class="col-md-3">
                                    <label for="dd"></label>
                                    ...
                                    <div class="form-group">
                                      ...
                                      @if(isset($all_Location)  && count($all_Location))  
                                          @foreach($all_Location as  $value)
                                            <label>
                                                <input type="checkbox" {{ (is_array(explode(',',$get_checking[0]->location)) and in_array($value->id, explode(',',$get_checking[0]->location))) ? ' checked' : '' }} name="location[]" class="minimal " value="{{$value->id}}"  />&nbsp;{{$value->name}} &nbsp;                               
                                            <label>
                                          @endforeach
                                       @endif
                                       <!--  <label>
                                            <input type="checkbox" @if(in_array("shelf",explode(',',$get_checking[0]->location))) checked @endif name="location[]" class="minimal" value="shelf"  />&nbsp;Shelf                                
                                        </label>
                                        <label>
                                            <input type="checkbox" @if(in_array("fridge",explode(',',$get_checking[0]->location))) checked @endif name="location[]" class="minimal" value="fridge"  />&nbsp;Fridge
                                        </label>
                                        <label>
                                            <input type="checkbox" @if(in_array("safe",explode(',',$get_checking[0]->location))) checked @endif name="location[]" class="minimal" value="safe"  />&nbsp;Safe
                                        </label> -->
                                    </div>
                                </div>
                              ...
                              <div class="">
                                <button type="submit" class="btn btn-primary">Update Checkings</button>
                              </div>
