 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">{{__('Edit pickups')}}</li>
          </ol>
        </section>
                  ...
                  <div class="box-body">
                        <div class="col-md-6">
                          ...
                          @endphp
                            ...
                            <div class="form-group">
                              ...
                              <input type="number" class="form-control" value="{{$pickups->no_of_weeks}}" maxlength="2" onkeypress="return restrictAlphabets(event);" id="no_of_weeks"   name="no_of_weeks" placeholder="No Of Weeks">
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <!-- <button type="button" id="signature-pad-save">Save</button> -->
                                  ...
                                  <!-- <button type="button" id="signature-pad-showPointsToggle">Show points?</button> -->
                                   ...
                                   <img  src="{{$pickups->pharmacist_sign}}" style="border: 1px solid lightgray;width: 85%;"/>

                               </div>
                            </div> <!-- END OF FIRST SIGNATURE  -->
 
                            <div class="form-group">
                               <label for="patient_sign"> <span class="signature_who_pickup">@if($pickups->pick_up_by=='carer') Carer @else Patients @endif</span> {{__('Signature')}}</label>
                             </div>
                             ...
                             <div class="row">
                              ...
                              <!-- <button type="button" id="signature-pad2-save">Save</button> -->
                                  ...
                                  <!-- <button type="button" id="signature-pad2-showPointsToggle">Show points?</button> -->
                                   ...
                                   <div >Draw Your Signature</div>
                                   <img  src="{{$pickups->patient_sign}}" style="border: 1px solid lightgray;width: 85%;"/>
                               </div>
                        ...
                        <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="date"  readonly class="form-control"  value="{{$pickups->patients->dob}}"  name="dob" id="dob" max="{{Carbon\Carbon::now()->format('Y-m-d')}}" placeholder="Date Of Birth" >
                              </div>
                              ...
                              <div class="form-group checkbox-wrp">
                               ...
                               <!-- radio -->
                              <label class="mt-20">{{__('Who is picking up ?')}}<span style="color:red">*</span></label>
