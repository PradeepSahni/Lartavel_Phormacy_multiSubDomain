          ...
          <div class="row">
              ...
              <div class="box box-primary">
                <div class="box-header pre-wrp">
                    <form action="{{ url('add_technician') }}" method="post" >  <!--dashboard-->
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-xs-6">  
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                   ...
                                   <textarea name="address"  required style="resize:none;" id="address" onFocus="geolocate()" class="form-control @error('address') is-invalid @enderror" cols="30" rows="5" placeholder="Enter address">{{old('address')}}</textarea>
                                    @error('address')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                            ...
                            <div class="col-xs-6">
                                ...
                                <label for="confirm_password">{{__('Confirm Password')}} <span style="color:red">*</span></label>
                                    <input type="password" required name="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" placeholder="Confirm Password"/>
