...
@section('content')
 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           {{__('Add Notes For Patient')}}
            <small>{{__('Preview')}}</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> {{__('Home')}}</a></li>
            <li><a href="dashboard">{{__('Notes For Patient')}}</a></li>
            <li class="active">{{__('Add Notes For Patient')}}</li>
          </ol>
        </section>
                  ...
                  <div class="box-body">
                        ...
                        <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input value="{{old('dob')}}" readonly  type="date" class="form-control @error('dob') is-invalid @enderror" max="{{Carbon\Carbon::now()->format('Y-m-d')}}"  name="dob" id="dob" placeholder="Date Of Birth" >
                                @error('dob')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                     ...
                     <div class="col-md-12">
                           ...
                           <div class="form-group">
                                ...
                                <textarea class="form-control @error('notes_for_patients') is-invalid @enderror"  style="resize: none;" rows="4" name="notes_for_patients" id="notes_for_patients"   placeholder="Note For Patient.">{{old('notes_for_patients')}}</textarea>
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="checkbox"  {{old('notes_as_text')?'checked':''}} name="notes_as_text" class="minimal @error('notes_as_text') is-invalid @enderror" value="1"  />&nbsp;{{__('Send the note as a text message')}}
                                </label>
                                @error('notes_as_text')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
