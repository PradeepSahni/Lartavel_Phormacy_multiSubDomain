 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">{{__('Add Near Miss')}}</li>
          </ol>
        </section>
        <!-- Main content -->
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group checkbox-wrp">
                                ...
                                <label><input   {{old('wrong_day')?'checked':''}}     type="checkbox" name="wrong_day"     class="minimal @error('no_of_weeks') is-invalid @enderror" value="wrong_day"  />&nbsp;{{__('Wrong day')}}</label>&nbsp;
                                 <label>
                                    <input type="checkbox" id="other_checkbox" name="other_checkbox" class="minimal"   />&nbsp;{{__('other')}}
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="{{old('person_involved')}}"  class="form-control @error('person_involved') is-invalid @enderror" maxlength="20"   id="person_involved"  name="person_involved" placeholder="Person Involved.">
                              ...
                              <div class="form-group">
                                ...
                                <input type="txet" value="{{old('initials')}}" class="form-control @error('initials') is-invalid @enderror" name="initials" id="initials"   placeholder="Initials." />
                                  @error('initials')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
