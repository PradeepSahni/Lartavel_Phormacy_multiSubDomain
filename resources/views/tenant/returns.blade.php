          ...
          <div class="row">
            ...
            @endif
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="{{url('save_return')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                  <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                              <label for="no_of_returned_day_weeks">{{__('Number of days/weeks returned')}} </label>
                              <input type="text" value="{{old('no_of_returned_day_weeks')}}" class="form-control" maxlength="2" onkeypress="return restrictAlphabets(event);" id="no_of_returned_day_weeks"   name="no_of_returned_day_weeks" placeholder="no of returned day weeks">
                            </div>
                            ...
                            <div class="form-group">
                               ...
                               <input type="text" value="{{old('initials')}}" name="initials" id="initials" class="form-control"  placeholder="initials">
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="date" readonly class="form-control" value="{{old('dob')}}"  name="dob" id="dob" placeholder="Date Of Birth" max="{{Carbon\Carbon::now()->format('Y-m-d')}}" >
                            </div>
                            <div class="form-group">
