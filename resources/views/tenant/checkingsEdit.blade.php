 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">{{__('Edit Checkings')}}</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            @endif
              ...
              <div class="box box-primary">
                ...
                <form role="form" id="addCheckings" action="{{url('checkings/edit/'.$checkings->id)}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                  <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <select name="patient_id" id="patient" class="form-control" >
                                ...
                                @foreach($patients as $patient)
                                  <option {{$patient->id==$checkings->patients->id?'selected=selected':''}} data-dob="{{$patient->dob}}" data-lastPickupDate="{{$patient->latestcheckings?$patient->latestcheckings->created_at:''}}"  data-lastPickupWeek="{{$patient->latestcheckings?$patient->latestcheckings->no_of_weeks:''}}" value="{{$patient->id}}">{{$patient->first_name.' '.$patient->last_name}} ( {{$patient->dob?date("j/n",strtotime($patient->dob)):""}} ) </option>
                                @endforeach
                              </select>
                            </div>
                            ...
                            <div class="form-group">
                               <label for="pharmacist_signature"  id="pharmacistSignDiv"> {{__('Pharmacist Signature')}}</label>
                            </div>
                            <div class="row">
                               <div class="col-md-7">
                               ...
                               <div class="col-md-5">
                                <div class="signature-component btn btn-group">
                                  ...
                                  <button type="button" id="clear">{{__('Clear')}}</button>
                                  <!-- <button type="button" id="showPointsToggle">{{__('Show points?')}}</button> -->
                                </div> <img src="{{$checkings->pharmacist_signature}}" style="height:100px;">
                               </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" value="{{$checkings->no_of_weeks}}"  class="form-control" maxlength="10" onkeypress="return restrictAlphabets(event);" id="no_of_weeks"   name="no_of_weeks" placeholder="No Of Weeks">
                            </div>
                              <div class="row">
                                <div class="col-md-3">
                                    <label for="dd"></label>
                                    <div class="form-group">
                                        <label id="ddDiv">
                                            <input type="checkbox" name="dd" class="minimal" value="1"  {{$checkings->dd==1?'checked=checked':''}}  />&nbsp;DD                                </label>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-9">
                              ...
                              <div class="">
                                <button type="submit" class="btn btn-primary" id="add_checking">{{__('Update Checkings')}}</button>
                              </div>
