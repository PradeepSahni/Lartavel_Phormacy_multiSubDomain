 ...
 <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">{{__('Add Checkings')}}</li>
          </ol>
        </section>
                  ...
                  <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <select data-placeholder="Select  Patient" multiple  name="patient_id[]" id="patient" class="form-control @error('patient_id') is-invalid @enderror">
                                <!-- <option></option> -->
                            ...
                            <div class="form-group">
                               <label for="pharmacist_signature"  id="pharmacistSignDiv"> {{__('Pharmacist Signature')}}<span style="color:red">*</span></label>
                            </div>
                            <div class="row">
                                <div class="col-md-7">
                               ...
                               <div class="col-md-5">
                                <div class="signature-component btn btn-group">
                                  ...
                                  <!-- <button type="button" id="showPointsToggle">{{__('Show points?')}}</button> -->
                                   ...
                                   <div >{{__('Draw Your Signature')}}</div>
                               </div>
                            </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label id="ddDiv">
                                            <input type="checkbox"  {{old('dd')?'checked':''}} name="dd" id="dd" class=" @error('dd') is-invalid @enderror minimal" value="1"  />&nbsp;DD                                </label>
                                        </label>
                                    </div>
                                    @error('dd')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-9">
                                  ...
                                  <div class="form-group">
                                    @foreach($locations as $location)
                                      <label>
                                          <input type="checkbox" {{ (is_array(old('location')) and in_array($location->id, old('location'))) ? ' checked' : '' }}  name="location[]" class="minimal @error('location[]') is-invalid @enderror" value="{{$location->id}}"  readonly="readonly"/>&nbsp;{{$location->name}}</label>
                                      <label>
                                    @endforeach
                                    @error('location[]')
                                  <span class="invalid-feedback" role="alert">
                              ...
                              <div class="">
                                ...
                                <button type="reset" class="btn btn-default" id="add_checking">{{__('Reset')}}</button>
                              </div>
